...
interface AutoDropItemPickerModalProps {
  isOpen: boolean;
  existingIds: number[];
...
export const AutoDropItemPickerModal: FC<AutoDropItemPickerModalProps> = ({
  isOpen,
  existingIds,
  onPick,
  onClose,
  ...
  return (
    ...
    >
      <DialogTitle className="sr-only">Adicionar regra de Auto Drop</DialogTitle>
